...
:: built-ins
set ffmpeg_options_builtin=cuda cuvid d3d11va dxva2 ^
iconv lzma nvenc schannel zlib sdl2

:: common external libs
set ffmpeg_options_basic=gmp libmp3lame libopus libvorbis libvpx libx264 ^
--disable-debug libfdk-aac
...
rem update
rem arvid call :runBash update.log /build/media-suite_update.sh --build32=%build32% --build64=%build64%
