...
#define FFMPEG_CONFIGURATION " --disable-static --enable-shared --pkg-config=pkgconf --cc='ccache gcc' --cxx='ccache g++' --ld='ccache g++' --enable-cuda --enable-cuvid --enable-d3d11va --enable-dxva2 --enable-iconv --enable-lzma --enable-nvenc --enable-schannel --enable-zlib --enable-sdl2 --enable-gmp --enable-libmp3lame --enable-libopus --enable-libvorbis --enable-libvpx --disable-debug --enable-libfdk-aac --enable-version3 --shlibdir=/local64/bin-video"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/local64/share/ffmpeg"
#define AVCONV_DATADIR "/local64/share/ffmpeg"
#define CC_IDENT "gcc 11.2.0 (Rev2, Built by MSYS2 project)"
